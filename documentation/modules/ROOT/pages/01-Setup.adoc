...
[source,bash,subs="+macros,+attributes"]
----
sshuttle -r root@<public ip of your machine> 192.168.122.0/24
----
...
[source,bash,subs="+macros,+attributes"]
----
sshuttle -r root@<public ip of your machine> 192.168.122.0/24  --ssh-cmd 'ssh -i <your certificate>.pem'
----
